    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="addBrandForm">
                <div class="modal-body">
                    <!-- Input Nama brand -->
                    <input value="{{ old('nama_brand') }}" type="text" name="nama_brand" class="mt-3 form-control nama_brand" placeholder="Enter brand Name" required>
                    <span class="text-danger error_nama_brand"></span>
    
                    <!-- Input Code brand -->
                    <input value="{{ old('code_brand') }}" type="text" name="code_brand" class="mt-3 form-control code_brand" placeholder="Enter brand Code" required>
        ...
        <!-- <div class="container">
            <div class="row mt-2">
                <div class="col-md-4">
                    <div class="card">
                        <h5 class="card-header text-success text-center">Add New brand</h5>
                        <div class="card-body">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="editBrandForm">
                <div class="modal-body">
                    <input id="nama_brand" name="nama_brand" type="text" class="mt-3 form-control" placeholder="Enter brand Name" required>
                    <input id="code_brand" name="code_brand" type="text" class="mt-3 form-control" placeholder="Enter brand Code" required>
                    <span class="text-danger" id="error_nama_brand"></span>
                </div>
                <div class="modal-footer">
